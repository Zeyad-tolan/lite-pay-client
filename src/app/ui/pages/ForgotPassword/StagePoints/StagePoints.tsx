import { ForgotPasswordPartFourIcon, ForgotPasswordPartOneIcon, ForgotPasswordPartThreeIcon, ForgotPasswordPartTwoIcon } from "@/src/app/icons/icons";
...
export default function StagePoints({ parts, setParts }: StagePointsProps) {
  return (
    <>
      {
        parts == 1 ?
          <ForgotPasswordPartOneIcon setParts={setParts} props={{ className: "md:w-3/6 w-full" }} /> :
          parts == 2 ?
